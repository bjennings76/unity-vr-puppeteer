    ...
    public class VRTK_SDKSetupEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUILayout.VerticalScope("Box"))
            {
                ...
                Func<VRTK_SDKInfo, System.Collections.ObjectModel.ReadOnlyCollection<VRTK_SDKInfo>, string> sdkNameSelector = (info, installedInfos)
        ...
        private void DrawAndHandleSDKSelection<BaseType>(string description, int indentLevelToRemove) where BaseType : SDK_Base
        {
			...
			System.Collections.ObjectModel.ReadOnlyCollection<VRTK_SDKInfo> availableSDKInfos = (System.Collections.ObjectModel.ReadOnlyCollection<VRTK_SDKInfo>)sdkManagerType
                .GetProperty(string.Format("Available{0}SDKInfos", baseName), BindingFlags.Public | BindingFlags.Static)
                .GetGetMethod()
                .Invoke(null, null);
	        System.Collections.ObjectModel.ReadOnlyCollection<VRTK_SDKInfo> installedSDKInfos = (System.Collections.ObjectModel.ReadOnlyCollection<VRTK_SDKInfo>)sdkManagerType
